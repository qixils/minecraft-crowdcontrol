...
namespace CrowdControl.Games.Packs
{
    public class MinecraftServer : SimpleTCPPack
    {
        ...
        public override List<Effect> Effects => new List<Effect>
        {
            ...
            new Effect("Damage Item", "damage_item", "miscellaneous") {Price = 100, Description = "Halves the durability of the held item"},
            ...
            new Effect("Dig Hole", "dig", "miscellaneous") {Price = 300, Description = "Digs a small hole underneath the streamer"},
            ...
            new Effect("Horse", "entity_horse", "summon_entity") {Price = 300},
