## Fabric 1.20.1 Client Installation
...
2. Ensure the Minecraft version is set to 1.20.1 and click the `Install` button.
...
9. Launch your modded instance of Minecraft 1.20.1 and open the world you want to play on.
