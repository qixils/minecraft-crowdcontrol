...
> **Warning**  
> Crowd Control is no longer being updated for Paper 1.17.1. Please use the
...
5. Download the
   [Paper plugin jar](https://modrinth.com/mod/crowdcontrol/versions?l=paper&g=1.17.1)
