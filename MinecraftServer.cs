...
namespace CrowdControl.Games.Packs
{
    ...
    public class MinecraftServer : SimpleTCPPack<SimpleTCPClientConnector>
    {
        ...
        private static readonly List<Effect> AllEffects = new()
        {
            ...
            new Effect("Repair Held Item", "repair_item", "inventory") { Price = 50, Description = "Fully repairs a damaged item" },
            ...
            new Effect("Armor Stand", "entity_armor_stand", "summon_entity") { Price = 150 },
            new Effect("Axolotl", "entity_axolotl", "summon_entity") { Price = 100 },
            new Effect("Bat", "entity_bat", "summon_entity") { Price = 10 },
            new Effect("Bee", "entity_bee", "summon_entity") { Price = 100 },
            ...
            new Effect("Dolphin", "entity_dolphin", "summon_entity") { Price = 100 },
            new Effect("Donkey", "entity_donkey", "summon_entity") { Price = 100 },
            new Effect("Drowned", "entity_drowned", "summon_entity") { Price = 200 },
            ...
            new Effect("Endermite", "entity_endermite", "summon_entity") { Price = 250 },
            new Effect("Evoker", "entity_evoker", "summon_entity") { Price = 600 },
            new Effect("Fox", "entity_fox", "summon_entity") { Price = 100 },
            new Effect("Frog", "entity_frog", "summon_entity") { Price = 100 },
            ...
            new Effect("Glow Squid", "entity_glow_squid", "summon_entity") { Price = 100 },
            new Effect("Goat", "entity_goat", "summon_entity") { Price = 100 },
            new Effect("Guardian", "entity_guardian", "summon_entity") { Price = 300 },
            new Effect("Hoglin", "entity_hoglin", "summon_entity") { Price = 800 },
            new Effect("Horse", "entity_horse", "summon_entity") { Price = 100 },
            new Effect("Husk", "entity_husk", "summon_entity") { Price = 200 },
            new Effect("Illusioner", "entity_illusioner", "summon_entity") { Price = 400 },
            ...
            new Effect("Llama", "entity_llama", "summon_entity") { Price = 100 },
            new Effect("Magma Cube", "entity_magma_cube", "summon_entity") { Price = 400 },
            new Effect("Minecart", "entity_minecart", "summon_entity") { Price = 25 },
            new Effect("Minecart with Chest", "entity_minecart_chest", "summon_entity") { Price = 100 },
            new Effect("Mooshroom", "entity_mushroom_cow", "summon_entity") { Price = 100 },
            new Effect("Mule", "entity_mule", "summon_entity") { Price = 100 },
            new Effect("Ocelot", "entity_ocelot", "summon_entity") { Price = 100 },
            new Effect("Panda", "entity_panda", "summon_entity") { Price = 100 },
            new Effect("Parrot", "entity_parrot", "summon_entity") { Price = 100 },
            new Effect("Phantom", "entity_phantom", "summon_entity") { Price = 300 },
            new Effect("Pig", "entity_pig", "summon_entity") { Price = 100 },
            new Effect("Piglin", "entity_piglin", "summon_entity") { Price = 300 },
            new Effect("Piglin Brute", "entity_piglin_brute", "summon_entity") { Price = 1000 },
            new Effect("Pillager", "entity_pillager", "summon_entity") { Price = 350 },
            new Effect("Polar Bear", "entity_polar_bear", "summon_entity") { Price = 100 },
            new Effect("Primed TNT", "entity_primed_tnt", "summon_entity") { Price = 500 },
            ...
            new Effect("Shulker", "entity_shulker", "summon_entity") { Price = 400 },
            ...
            new Effect("Stray", "entity_stray", "summon_entity") { Price = 325 },
            new Effect("Strider", "entity_strider", "summon_entity") { Price = 100 },
            new Effect("Tadpole", "entity_tadpole", "summon_entity") { Price = 100 },
            new Effect("Trader Llama", "entity_trader_llama", "summon_entity") { Price = 100 },
            new Effect("Tropical Fish", "entity_tropical_fish", "summon_entity") { Price = 100 },
            new Effect("Turtle", "entity_turtle", "summon_entity") { Price = 100 },
            new Effect("Vex", "entity_vex", "summon_entity") { Price = 300 },
            new Effect("Villager", "entity_villager", "summon_entity") { Price = 150 },
            new Effect("Vindicator", "entity_vindicator", "summon_entity") { Price = 500 },
            new Effect("Wandering Trader", "entity_wandering_trader", "summon_entity") { Price = 150 },
            new Effect("Warden", "entity_warden", "summon_entity") { Price = 3000 },
            new Effect("Witch", "entity_witch", "summon_entity") { Price = 300 },
            new Effect("Wither", "entity_wither", "summon_entity") { Price = 3000 },
            new Effect("Wither Skeleton", "entity_wither_skeleton", "summon_entity") { Price = 400 },
            new Effect("Wolf", "entity_wolf", "summon_entity") { Price = 200 },
            new Effect("Zoglin", "entity_zoglin", "summon_entity") { Price = 1000 },
            new Effect("Zombie", "entity_zombie", "summon_entity") { Price = 200 },
            new Effect("Zombie Horse", "entity_zombie_horse", "summon_entity") { Price = 100 },
            new Effect("Zombie Villager", "entity_zombie_villager", "summon_entity") { Price = 200 },
            new Effect("Zombified Piglin", "entity_zombified_piglin", "summon_entity") { Price = 200 },
            ...
            new Effect("Recovery Compass", "give_recovery_compass", new[]{"items64"}, "give_item") { Price = 400 },
            new Effect("Trident", "give_trident", "give_item") { Price = 300 },

            new Effect("Food", "give_food", ItemKind.Folder, "give_item"),
            new Effect("Cooked Porkchop", "give_cooked_porkchop", new[]{"items64"}, "give_food") { Price = 40 },
            ...
            new Effect("Coal", "give_coal", new[]{"items64"}, "give_minerals") { Price = 10 },
            new Effect("Gold Ingot", "give_gold_ingot", new[]{"items64"}, "give_minerals") { Price = 20 },
            new Effect("Iron Ingot", "give_iron_ingot", new[]{"items64"}, "give_minerals") { Price = 25 },
            new Effect("Diamond", "give_diamond", new[]{"items64"}, "give_minerals") { Price = 100 },
            new Effect("Netherite Ingot", "give_netherite_ingot", new[]{"items64"}, "give_minerals") { Price = 150 },
