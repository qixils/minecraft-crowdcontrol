...
namespace CrowdControl.Games.Packs
{
    ...
    public class MinecraftServer : SimpleTCPPack<SimpleTCPClientConnector>
    {
        ...
        private static readonly List<Effect> AllEffects = new()
        {
            ...
            new Effect("Zero Gravity", "zero_gravity", "gravity") { Price = 75, Duration = 20, Description = "Disables the streamer's gravity" },
            // freeze-type commands
            new Effect("Freezing", "freezing", ItemKind.Folder),
            new Effect("Freeze Feet", "freeze", "freezing") { Price = 100, Duration = 10, Description = "Temporarily prohibits movement" },
            new Effect("Freeze Camera", "camera_lock", "freezing") { Price = 100, Duration = 10, Description = "Temporarily freeze the streamer's camera" },
            new Effect("Lock Camera To Ground", "camera_lock_to_ground", "freezing") { Price = 150, Duration = 10, Description = "Temporarily locks the streamer's camera to the ground" },
            new Effect("Lock Camera To Sky", "camera_lock_to_sky", "freezing") { Price = 150, Duration = 10, Description = "Temporarily locks the streamer's camera to the sky" },
            new Effect("Disable Jumping", "disable_jumping", "freezing") { Price = 50, Duration = 10, Description = "Temporarily prevents the streamer from jumping" },
            // inventory commands
            ...
            new Effect("Spectator Mode", "spectator_mode", "change_gamemode") { Price = 150, Duration = 8, Description = "Temporarily sets the streamer to Spectator mode, turning them into a ghost that can fly through blocks" },
            new Effect("Allow Flight", "flight", "change_gamemode") { Price = 100, Duration = 15, Description = "Temporarily allows the streamer to fly" },
            ...
            new Effect("Invisibility", "potion_invisibility", "apply_potion_effect") { Price = 25, Duration = 20, Description = "Makes the player's skin invisible" },
            new Effect("Jump Boost", "potion_jump_boost", "apply_potion_effect") { Price = 50, Duration = 20, Description = "Makes the player jump higher" },
            ...
            new Effect("Mining Fatigue", "potion_mining_fatigue", "apply_potion_effect") { Price = 75, Duration = 20, Description = "Decreases mining speed" },
            new Effect("Nausea", "potion_nausea", "apply_potion_effect") { Price = 50, Duration = 20, Description = "Makes the player's screen shake" },
            ...
            new Effect("Regeneration", "potion_regeneration", "apply_potion_effect") { Price = 25, Duration = 20, Description = "Gradually heals the player" },
            new Effect("Resistance", "potion_resistance", "apply_potion_effect") { Price = 25, Duration = 20, Description = "Reduces damage taken" },
            new Effect("Slow Falling", "potion_slow_falling", "apply_potion_effect") { Price = 25, Duration = 20, Description = "Reduces the player's falling speed" },
