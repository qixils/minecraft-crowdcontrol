...
- Bumped cc4j, fixing socket reconnection issues
- Added support for LuckPerms on Paper
- Fixed inconsistent height of Dig Hole
- Fixed high default price of Summon effects autogenerated for passive mobs
