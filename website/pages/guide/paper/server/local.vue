...
<template>
  <div>
    ...
    <ol>
      <li>Download and install <a href="https://adoptium.net/">the latest version.id of Java</a>. Java 21 or later is required.</li>
    ...
    <p>Users may now connect using the <NuxtLink :to="`/guide/paper/join?v=${version.id}`"><strong>Joining a Server</strong></NuxtLink> guide. Make sure to provide your public IP address and the password used in the config file (default: <code>crowdcontrol</code>) to your streamers.</p>
