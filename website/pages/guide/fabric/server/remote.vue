...
<template>
  <div>
    ...
    <ol>
      ...
      <li>
        <PortInstructions :localLink="`/guide/fabric/server/local?v=${version.id}`" />
      </li>
    ...
    <p>Users may now connect using the <NuxtLink :to="`/guide/fabric/join?v=${version.id}`"><strong>Joining a Server</strong></NuxtLink> guide. Make sure to provide the server's IP address and the password used in the config file (default: <code>crowdcontrol</code>) to your streamers.</p>
