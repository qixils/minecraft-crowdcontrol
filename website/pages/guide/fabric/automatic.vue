...
useSeoMeta({
  title: `Fabric ${version.id} Automatic Server Setup · Minecraft Crowd Control`,
  description: `Fabric ${version.id} Automatic Server Setup Guide`,
  ogDescription: `Fabric ${version.id} Automatic Server Setup Guide`,
})
</script>

<template>
  <div>
    <h1>Fabric {{ version.id }} Automatic Setup</h1>
    ...
    <ol>
      ...
      <li>Under <strong>Select a Pack</strong>, choose the first option <strong>Minecraft</strong>.</li>
      ...
      <li>(Optional) For extra effects and the best experience, install the client mod using the <NuxtLink to="/guide/fabric/client">Client Setup</NuxtLink> guide.</li>
      ...
      <li>Open the <strong>Effect List</strong> or <strong>Effect Manager</strong> in the Crowd Control app to test effects.</li>
