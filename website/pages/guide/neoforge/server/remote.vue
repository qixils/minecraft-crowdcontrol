...
<template>
  <div>
    ...
    <ol>
      ...
      <li>Download the latest build of <a :href="`https://modrinth.com/mod/forgified-fabric-api/versions?l=neoforge&g=${version.id}&c=release`">Forgified Fabric API</a> and upload it to the <code>mods</code> folder.</li>
      ...
      <li>
        <PortInstructions :localLink="`/guide/neoforge/server/local?v=${version.id}`" />
      </li>
    ...
    <p>Users may now connect using the <NuxtLink :to="`/guide/neoforge/join?v=${version.id}`"><strong>Joining a Server</strong></NuxtLink> guide. Make sure to provide the server's IP address and the password used in the config file (default: <code>crowdcontrol</code>) to your streamers.</p>
