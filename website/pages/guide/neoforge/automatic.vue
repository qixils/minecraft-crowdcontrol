...
useSeoMeta({
  title: `NeoForge ${version} Automatic Server Setup · Minecraft Crowd Control`,
  description: `NeoForge ${version} Automatic Server Setup Guide`,
  ogDescription: `NeoForge ${version} Automatic Server Setup Guide`,
})
</script>

<template>
  <div>
    <h1>NeoForge {{ version }} Automatic Setup</h1>
