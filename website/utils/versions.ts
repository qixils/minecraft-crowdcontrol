...
export const spongeML = {name: "Sponge/Forge", id: "sponge", versions: spongeVersionsArray} as const satisfies Modloader;
export const modloaders = [unsureML, paperML, fabricML, spongeML] as const satisfies Modloader[];