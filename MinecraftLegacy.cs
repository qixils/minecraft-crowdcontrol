...
public class MinecraftLegacy : SimpleTCPPack<SimpleTCPClientConnector>
{
    ...
    public override EffectList Effects => new Effect[]
    {
        ...
        new("Give: Stick", "give_stick") { Price = 1, Inactive = true, Quantity = 64, SortName = "Give: 0: Stick", Category = "Give Items", Description = "Gives a stick, an ingredient used to craft tools" },
        // give items: food
        ...
        // give items: minerals
        new("Give: Coal", "give_coal") { Price = 10, Inactive = true, Quantity = 64, SortName = "Give: 2: 0: 1", Category = "Give Items", Description = "Gives a piece of Coal, a mineral that can be used to smelt ores and cook food" },
        new("Give: Gold Ingot", "give_gold_ingot") { Price = 20, Inactive = true, Quantity = 64, SortName = "Give: 2: 0: 2", Category = "Give Items", Description = "Gives a Gold Ingot, a mineral that can be used to craft tools, armor, and golden apples" },
        new("Give: Iron Ingot", "give_iron_ingot") { Price = 25, Quantity = 64, SortName = "Give: 2: 0: 3", Category = "Give Items", Description = "Gives an Iron Ingot, a mineral that can be used to craft tools, armor, and shields" },
        new("Give: Diamond", "give_diamond") { Price = 100, Quantity = 64, SortName = "Give: 2: 0: 4", Category = "Give Items", Description = "Gives a Diamond, a mineral that can be used to craft tools and armor" },
        new("Give: Netherite Ingot", "give_netherite_ingot") { Price = 200, Quantity = 64, SortName = "Give: 2: 0: 5", Category = "Give Items", Description = "Gives a Netherite Ingot, a mineral that can be used to upgrade diamond tools and armor" },
        ...
        new("Give: Mace", "give_mace") { Price = 500, SortName = "Give: 4: Mace", Category = "Give Items", Description = "Gives a Mace, a melee weapon which deals more damage the longer you fall" },
        ...
        // takes items: misc
        new("Take: Elytra", "take_elytra") { Price = 700, SortName = "Take: 0: Elytra", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Eye of Ender", "take_ender_eye") { Price = 200, Quantity = 64, SortName = "Take: 0: Eye of Ender", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: End Portal Frame", "take_end_portal_frame") { Price = 300, Quantity = 64, SortName = "Take: 0: End Portal Frame", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Recovery Compass", "take_recovery_compass") { Price = 500, Quantity = 64, SortName = "Take: 0: Recovery Compass", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Stick", "take_stick") { Price = 2, Inactive = true, Quantity = 64, SortName = "Take: 0: Stick", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        // take items: food
        new("Take: Cooked Porkchop", "take_cooked_porkchop") { Price = 100, Quantity = 64, SortName = "Take: 1: 0", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Golden Apple", "take_golden_apple") { Price = 400, Quantity = 64, SortName = "Take: 1: 8", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Enchanted Golden Apple", "take_enchanted_golden_apple") { Price = 500, Quantity = 64, SortName = "Take: 1: 9", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        // take items: minerals
        new("Take: Coal", "take_coal") { Price = 50, Inactive = true, Quantity = 64, SortName = "Take: 2: 0", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Gold Ingot", "take_gold_ingot") { Price = 100, Inactive = true, Quantity = 64, SortName = "Take: 2: 1", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Iron Ingot", "take_iron_ingot") { Price = 100, Quantity = 64, SortName = "Take: 2: 2", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Diamond", "take_diamond") { Price = 300, Quantity = 64, SortName = "Take: 2: 3", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Netherite Ingot", "take_netherite_ingot") { Price = 400, Quantity = 64, SortName = "Take: 2: 4", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        // take items: tools: pickaxes
        new("Take: Wooden Pickaxe", "take_wooden_pickaxe") { Price = 50, Inactive = true, SortName = "Take: 3: 0: 0", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Stone Pickaxe", "take_stone_pickaxe") { Price = 100, Inactive = true, SortName = "Take: 3: 0: 1", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Golden Pickaxe", "take_golden_pickaxe") { Price = 100, Inactive = true, SortName = "Take: 3: 0: 2", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Iron Pickaxe", "take_iron_pickaxe") { Price = 400, SortName = "Take: 3: 0: 3", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Diamond Pickaxe", "take_diamond_pickaxe") { Price = 500, SortName = "Take: 3: 0: 4", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Netherite Pickaxe", "take_netherite_pickaxe") { Price = 500, SortName = "Take: 3: 0: 5", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        // take items: weapons: swords
        new("Take: Wooden Sword", "take_wooden_sword") { Price = 50, Inactive = true, SortName = "Take: 4: 0: 0", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Stone Sword", "take_stone_sword") { Price = 100, Inactive = true, SortName = "Take: 4: 0: 1", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Golden Sword", "take_golden_sword") { Price = 100, Inactive = true, SortName = "Take: 4: 0: 2", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Iron Sword", "take_iron_sword") { Price = 400, SortName = "Take: 4: 0: 3", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Diamond Sword", "take_diamond_sword") { Price = 500, SortName = "Take: 4: 0: 4", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Netherite Sword", "take_netherite_sword") { Price = 500, SortName = "Take: 4: 0: 5", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        // take items: weapons: misc
        new("Take: Mace", "take_mace") { Price = 600, SortName = "Take: 4: Mace", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        new("Take: Trident", "take_trident") { Price = 400, SortName = "Take: 4: Trident", Category = "Take Items", Description = "Tries to take items from a player. Refunds after a minute if none can be found." },
        // shaders
