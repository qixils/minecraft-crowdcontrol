...
public final class Components {
	...
	public static final @NotNull String ORIGINAL_DISPLAY_NAME = fromNamespaceAndPath("crowdcontrol", "original-display-name-2").asString(); // renamed for new impl in 1.21.6
