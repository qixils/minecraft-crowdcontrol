...
public enum Condition {
	STAND_ON_DIRT(new StandOnBlockCondition("a %s block", Material.DIRT)),
	STAND_ON_STONE(new StandOnBlockCondition("a %s block", Material.STONE)),
	STAND_ON_COBBLESTONE(new StandOnBlockCondition("a %s block", Material.COBBLESTONE)),
	STAND_ON_SAND(new StandOnBlockCondition("a %s block", Material.SAND)),
