...
import dev.qixils.crowdcontrol.plugin.fabric.interfaces.impl.JumpStatusImpl;
...
public final class Components implements EntityComponentInitializer {
	...
	public static final @NotNull ComponentKey<JumpStatus> JUMP_STATUS = ComponentRegistry.getOrCreate(new ResourceLocation("crowd-control", "jump-status"), JumpStatus.class);
	...
	public void registerEntityComponentFactories(@NotNull EntityComponentFactoryRegistry registry) {
		...
		registry.registerForPlayers(JUMP_STATUS, JumpStatusImpl::new);
	}
}
