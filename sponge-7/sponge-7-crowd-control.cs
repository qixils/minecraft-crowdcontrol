...
namespace CrowdControl.Games.Packs
{
    public class MinecraftSponge : SimpleTCPPack<SimpleTCPClientConnector>
    {
        ...
        public override List<Effect> Effects => new List<Effect>
        {
            ...
            //no relevant api available - new Effect("Teleport to a Nearby Structure", "structure", "miscellaneous") {Price = 1000, Description = "Teleports players to a random nearby structure"},
            //no relevant api available - new Effect("Teleport to a Random Biome", "biome", "miscellaneous") {Price = 1000, Description = "Teleports players to a random nearby biome"},
...
//            new Effect("Hoglin", "entity_hoglin", "summon_entity") {Price = 1000}, // API8
            ...
            new Effect("Minecart with Furnace", "entity_minecart_furnace", "summon_entity") {Price = 50},
            new Effect("Minecart with Hopper", "entity_minecart_hopper", "summon_entity") {Price = 75},
            new Effect("Minecart with TNT", "entity_minecart_tnt", "summon_entity") {Price = 300},
...
//            new Effect("Hoglin", "remove_entity_hoglin", "remove_entity") {Price = 300}, //API8
            ...
            new Effect("Minecart with Furnace", "remove_entity_minecart_furnace", "summon_entity") {Price = 100},
            new Effect("Minecart with Hopper", "remove_entity_minecart_hopper", "summon_entity") {Price = 150},
            new Effect("Minecart with TNT", "remove_entity_minecart_tnt", "summon_entity") {Price = 200},
...
//            new Effect("Enchanted Golden Apple", "give_enchanted_golden_apple", "give_food") {Price = 300}, // API8
...
//            new Effect("Netherite Ingot", "give_netherite_ingot", "give_minerals") {Price = 300}, // API8
...
//            new Effect("Netherite Pickaxe", "give_netherite_pickaxe", "give_tools") {Price = 350}, // API8
...
//            new Effect("Netherite Sword", "give_netherite_sword", "give_weapons") {Price = 350}, // API8
...
//            new Effect("Enchanted Golden Apple", "take_enchanted_golden_apple", "take_food") {Price = 600}, // API8
...
//            new Effect("Netherite Ingot", "take_netherite_ingot", "take_minerals") {Price = 700}, // API8
...
//            new Effect("Netherite Pickaxe", "take_netherite_pickaxe", "take_tools") {Price = 750}, // API8
...
//            new Effect("Netherite Sword", "take_netherite_sword", "take_weapons") {Price = 750}, // API8
        };
    }
}
