...
{
    public class MinecraftSponge8 : SimpleTCPPack<SimpleTCPClientConnector>
    {
        // default port: 58731
        ...
        public MinecraftSponge8(IPlayer player, Func<CrowdControlBlock, bool> responseHandler, Action<object> statusUpdateHandler) : base(player, responseHandler, statusUpdateHandler) { }

        public override Game Game => new Game(999, "Minecraft (Sponge 8)", "MinecraftSponge8", "PC", ConnectorType.SimpleTCPClientConnector);
        ...
        public override List<Effect> Effects => new List<Effect>
        {
            ...
            // missing API: new Effect("Teleport to a Nearby Structure", "structure", "miscellaneous") {Price = 1000, Description = "Teleports players to a random nearby structure"},
            // missing API: new Effect("Teleport to a Random Biome", "biome", "miscellaneous") {Price = 1000, Description = "Teleports players to a random nearby biome"},
