...
public enum Condition {
	STAND_ON_DIRT(new StandOnBlockCondition(2, "generic", BlockTypes.DIRT.get())),
	STAND_ON_STONE(new StandOnBlockCondition(2, "generic", BlockTypes.STONE.get())),
	STAND_ON_COBBLESTONE(new StandOnBlockCondition(2, "generic", BlockTypes.COBBLESTONE.get())),
	STAND_ON_SAND(new StandOnBlockCondition(3, "generic", BlockTypes.SAND.get())),
	STAND_ON_A_BED(new StandOnBlockCondition(4, "bed",
	...
	STAND_ON_A_STRIPPED_LOG(new StandOnBlockCondition(3, "stripped_log",
	...
	OBTAIN_STONE_HOE(new ObtainItemCondition(3, "generic", ItemTypes.STONE_HOE.get())),
	OBTAIN_WOODEN_HOE(new ObtainItemCondition(2, "generic", ItemTypes.WOODEN_HOE.get())),
	OBTAIN_STONE(new ObtainItemCondition(4, "generic_block", ItemTypes.STONE.get())),
	;
